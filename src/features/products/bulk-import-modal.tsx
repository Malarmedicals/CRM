    ...
    const validated: ValidationResult[] = rows.map((row: any, index: number) => {
      ...
      const mappedProduct = {
        ...
        medicalInfo: {
          ...
          dosageForm: row['Dosage Form']?.toString().trim() || row['Form']?.toString().trim(),
          strength: row['Strength']?.toString().trim() || row['Dosage']?.toString().trim(),
          packSize: row['Pack Size']?.toString().trim() || row['Package Size']?.toString().trim(),
          consumingMethod: row['Consuming Option']?.toString().trim() || row['Consuming Method']?.toString().trim() || row['Route']?.toString().trim(),
          consumingTiming: row['Consuming Timing']?.toString().trim() || row['Timing']?.toString().trim(),
          consumingFrequency: row['Consuming Frequency']?.toString().trim() || row['Frequency']?.toString().trim(),
